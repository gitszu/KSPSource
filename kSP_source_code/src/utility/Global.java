...
public class Global {
	...
	public static String edgeFile = null;
	...
	public static int numNodes = -1;//include nodes that are places
	public static int numKeywords = -1;
	public static int numEdges = -1;
	public static int numSCCs = -1;// # of vertx SCCs + # of keywords
