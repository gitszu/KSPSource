...
public class RTreeWithGI extends RTree {
	...
	public RTreeWithGI(PropertySet psRTree, IStorageManager sm) throws Exception {
		...
		iindex = new InvertedIndexHash(buffer, iindexname + ".iindex", Global.iindexIsCreate,
				Global.iindexPageSize, Global.iindexBufferSize);
	}
	 ...
	 * @throws IOException
	 */
	public ArrayList readPostingList(int word) throws IOException {
		ArrayList postinglist = iindex.readPostingList(word, Global.iindexIsWeighted);
		return postinglist;
	}
