...
public class MTSP_Task implements Callable<String>{
	...
	public MTSP_Task(RTreeWithGI rgi,VertexQwordsMap<Integer> vertexQwordsMap,Map<Integer, Map<Integer, Float>> alphaPostinglists,
