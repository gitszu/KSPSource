        ...
        E, FibonacciHeapNode<ClosestFirstIterator.QueueEntry<V, E>>>
{
    ...
    {//AddReachable if not reachable we do not need insert to heap but do we need to make it seen? And we do not need to do the shortest path calculation below
